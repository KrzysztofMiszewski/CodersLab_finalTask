...
Feature: add address
  ...
  Scenario Outline: user can add new address
    ...
    Given an open browser with "https://mystore-testlab.coderslab.pl" AddAddressTest
    ...
    Examples:
      ...
      | Oklahoma | 3946 Ottis Street     | Oklahoma City | 73102  | United Kingdom | 405-278-2303 |